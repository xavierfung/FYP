...
/**
 * Created by Xavier on 29/2/2016.
 */
public class RegisterActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btnLinkToLogin = (Button) findViewById(R.id.btn_backlogin);
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                if (!auth.isEmpty() && !username.isEmpty() && !password.isEmpty()) {
     ...
     */
    private void registerUser(final String authority, final String username,
